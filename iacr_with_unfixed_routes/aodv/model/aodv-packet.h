...
enum MessageType
{
    ...
    AODVTYPE_ICREP = 5   // NEW: Information Collection Reply
    // AODVTYPE_ICREP = 6    // NEW: Information Collection Reply
};

/**
 * @ingroup aodv
 * @brief Information Collection Request Header
 */
class IcReqHeader : public Header
{
public:
    IcReqHeader(Ipv4Address transmitter = Ipv4Address(),
                double txPower = 0.0);
    ...
    void SetTransmitter(Ipv4Address addr);
    // void SetDestination(Ipv4Address addr);
    void SetTxPower(double power);

    Ipv4Address GetTransmitter() const;
    // Ipv4Address GetDestination() const;
    double GetTxPower() const;

private:
    Ipv4Address m_transmitter;
...
/**
 * @ingroup aodv
 * @brief Information Collection Reply Header
 */
class IcRepHeader : public Header
{
public:
    IcRepHeader(Ipv4Address transmitter = Ipv4Address(),
    ...
    void SetTransmitter(Ipv4Address addr);
    // void SetDestination(Ipv4Address addr);
    void SetReceivedPower(double power);
    void SetInterference(double interference);

    Ipv4Address GetTransmitter() const;
    // Ipv4Address GetDestination() const;
    double GetReceivedPower() const;
    double GetInterference() const;

private:
    Ipv4Address m_transmitter;
    // Ipv4Address m_destination;
    double m_pr;   // Received power
    double m_ir;   // Received interference
};
...
class RreqHeader : public Header
{
  public:
    ...
    void SetPrevMetric(double metric)
    {
        m_prevMetric = metric;
    }

    double GetPrevMetric() const
    {
        return m_prevMetric;
    }


    void setCreatedInterference(double interference)
    {
        m_createdInterference = interference;
    }   

    double getCreatedInterference() const
    {
  ...
  private:
    ...
    double m_createdInterference{0.0}; ///< Created interference for the route
