...
enum MessageType
{
    IACRTYPE_RREQ = 1,    //!< IACRTYPE_RREQ
    IACRTYPE_RREP = 2,    //!< IACRTYPE_RREP
    IACRTYPE_RERR = 3,    //!< IACRTYPE_RERR
    IACRTYPE_RREP_ACK = 4 //!< IACRTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * @param t the IACR RREQ type
     */
    TypeHeader(MessageType t = IACRTYPE_RREQ);
