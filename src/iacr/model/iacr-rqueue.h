 ...
 */
#ifndef IACR_RQUEUE_H
#define IACR_RQUEUE_H
...
/**
 * @ingroup iacr
 * @brief IACR route request queue
 *
 * Since IACR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
