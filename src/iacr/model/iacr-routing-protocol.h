 ...
 */
#ifndef IACRROUTINGPROTOCOL_H
#define IACRROUTINGPROTOCOL_H

#include "iacr-dpd.h"
#include "iacr-neighbor.h"
#include "iacr-packet.h"
#include "iacr-rqueue.h"
#include "iacr-rtable.h"
...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    static const uint32_t IACR_PORT;
  ...
  private:
     ...
     */
    void RecvIacr(Ptr<Socket> socket);
    /**
     * Receive RREQ
     * @param p packet
