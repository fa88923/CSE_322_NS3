 ...
 * @ingroup iacr
 *
 * @brief IACR loopback UDP echo test case
 */
 ...
 * @ingroup iacr-test
 *
 * @brief IACR Loopback test suite
 */
class IacrLoopbackTestSuite : public TestSuite
{
  public:
    IacrLoopbackTestSuite()
        : TestSuite("routing-iacr-loopback", Type::SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::Duration::QUICK);
    }
} g_iacrLoopbackTestSuite; ///< the test suite
